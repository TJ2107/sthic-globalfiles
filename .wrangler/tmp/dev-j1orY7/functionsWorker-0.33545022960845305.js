...
// .wrangler/tmp/bundle-wuBjCx/checked-fetch.js
...
// .wrangler/tmp/bundle-wuBjCx/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-R8X3rq/functionsWorker-0.33545022960845305.mjs
...
var onRequest = /* @__PURE__ */ __name2(async (context) => {
  ...
  const getResponse = /* @__PURE__ */ __name2(async () => {
    ...
    if (pathname === "/api/retable/workspaces") {
      try {
        const response2 = await fetch("https://api.retable.io/v1/public/workspaces", {
          headers: { "ApiKey": apiKey }
        });
        if (!response2.ok) {
          throw new Error(`Retable API error: ${response2.status}`);
        }
        ...
        return new Response(JSON.stringify({
          ...
          data: {
            workspaces: [
              { id: "ws-demo-01", name: "Espace D\xE9mo - Suivi PM Retable (Fallback)" }
            ]
          }
        }), { headers: { "Content-Type": "application/json" } });
      }
    ...
    if (pathname === "/api/retable/projects") {
      ...
      try {
        const response2 = await fetch(`https://api.retable.io/v1/public/workspaces/${workspaceId}/projects`, {
          headers: { "ApiKey": apiKey }
        });
        if (!response2.ok) throw new Error(`Retable API error: ${response2.status}`);
        const data = await response2.json();
        return new Response(JSON.stringify(data), { headers: { "Content-Type": "application/json" } });
      } catch (error) {
        return new Response(JSON.stringify({
          ...
          data: {
            projects: [
              { id: "proj-demo-01", name: "Projet Maintenance T\xE9l\xE9com 2026 (Fallback)" }
            ]
          }
        }), { headers: { "Content-Type": "application/json" } });
      }
    ...
    if (pathname === "/api/retable/tables") {
      ...
      try {
        const response2 = await fetch(`https://api.retable.io/v1/public/projects/${projectId}/tables`, {
          headers: { "ApiKey": apiKey }
        });
        if (!response2.ok) throw new Error(`Retable API error: ${response2.status}`);
        const data = await response2.json();
        ...
        return new Response(JSON.stringify({
          ...
          data: {
            tables: [
              { id: "tab-demo-01", title: "Suivi PM S\xE9n\xE9gal Global (Fallback)" }
            ]
          }
        }), { headers: { "Content-Type": "application/json" } });
      }
    ...
    if (pathname === "/api/retable/data") {
      ...
      try {
        const response2 = await fetch(`https://api.retable.io/v1/public/retable/${retableId}/data`, {
          headers: { "ApiKey": apiKey }
        });
        if (!response2.ok) throw new Error(`Retable API error: ${response2.status}`);
        ...
        const rows = rawRows.map((row) => {
          const flatRow = { id: row.row_id || row.id };
...
// .wrangler/tmp/bundle-wuBjCx/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wuBjCx/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.33545022960845305.js.map
